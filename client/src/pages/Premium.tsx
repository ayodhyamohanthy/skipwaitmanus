...
const packs: Pack[] = [
  ...
  { id: "skipwait_token_1-USD", tokens: 1, price: 1, currency: "USD", billingCountry: "INTL", label: "International billing", audience: "Razorpay International / Export" },
];
