...
export default function ShareHub() {
  ...
  const share = async (audience: Audience, channel: "whatsapp" | "email" | "linkedin" | "x" | "more" | "copy") => {
