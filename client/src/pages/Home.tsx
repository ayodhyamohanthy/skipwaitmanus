  ...
  return <main className="min-h-screen bg-slate-50 text-slate-950">
    ...
    <section className="mx-auto grid max-w-6xl items-center gap-10 px-5 pb-12 pt-10 sm:px-6 sm:pt-12 lg:grid-cols-[1.08fr_.92fr] lg:gap-14 lg:pb-24 lg:pt-20">
      <div>
        ...
        <h1 className="max-w-2xl text-balance text-[2.4rem] font-semibold leading-[.94] tracking-[-.06em] sm:mt-5 sm:text-6xl"><span className="sm:hidden">Choose your referral path.</span><span className="hidden sm:inline">Ask for a referral.<br />Or give one.</span></h1>
        <p className="mt-3 text-base leading-6 text-slate-600 sm:mt-4 sm:max-w-xl sm:text-lg sm:leading-7"><span className="sm:hidden">One clear step. Pick what you need to do.</span><span className="hidden sm:inline">Put the right opportunity in front of the right person—whether you are making the ask or making the introduction.</span></p>
        <div className="mt-7 sm:mt-8"><p className="mb-3 hidden text-xs font-bold uppercase tracking-[.14em] text-slate-500 sm:block">What brings you here?</p><div className="grid gap-3 sm:max-w-xl sm:grid-cols-2">
          <button onClick={() => go("/start")} className="group flex min-h-[104px] items-center justify-between rounded-2xl bg-[#0B57D0] p-5 text-left text-white shadow-sm transition active:scale-[.98] hover:bg-[#0847AD] sm:min-h-[146px]"><span><span className="hidden items-center gap-2 text-[11px] font-bold uppercase tracking-[.13em] text-blue-100 sm:flex"><Sparkles className="h-3.5 w-3.5" />Job Seeker</span><span className="block text-xl font-semibold sm:mt-3">I need a referral</span><span className="mt-1 block text-sm leading-5 text-blue-100 sm:mt-2">Share the role. Add your resume.</span><span className="mt-3 hidden items-center gap-1 text-sm font-bold sm:inline-flex">Ask for a referral <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" /></span></span><ArrowRight className="h-5 w-5 shrink-0 sm:hidden" /></button>
          <button onClick={() => go("/referrer")} className="group flex min-h-[104px] items-center justify-between rounded-2xl border border-slate-200 bg-white p-5 text-left shadow-sm transition active:scale-[.98] hover:border-blue-200 hover:bg-blue-50/30 sm:min-h-[146px]"><span><span className="hidden items-center gap-2 text-[11px] font-bold uppercase tracking-[.13em] text-[#0B57D0] sm:flex"><HeartHandshake className="h-3.5 w-3.5" />Referrer</span><span className="block text-xl font-semibold text-slate-950 sm:mt-3">I give referrals</span><span className="mt-1 block text-sm leading-5 text-slate-600 sm:mt-2">Review the request. Help your way.</span><span className="mt-3 hidden items-center gap-1 text-sm font-bold text-[#0B57D0] sm:inline-flex">Give a referral <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" /></span></span><ArrowRight className="h-5 w-5 shrink-0 text-[#0B57D0] sm:hidden" /></button>
        </div></div>
