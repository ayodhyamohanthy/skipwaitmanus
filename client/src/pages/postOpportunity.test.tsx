...
vi.mock("@clerk/react", () => ({ SignInButton: ({ children }: { children: React.ReactNode }) => children, useAuth: () => ({ isSignedIn: true, getToken }) }));

afterEach(() => { cleanup(); vi.unstubAllGlobals(); getToken.mockClear(); });
