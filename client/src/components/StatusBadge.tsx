...
const statusStyles: Record<ReferralStatus, string> = { pending: "bg-amber-50 text-amber-700 ring-amber-200", approved: "bg-sky-50 text-sky-700 ring-sky-200", declined: "bg-rose-50 text-rose-700 ring-rose-200", intro_made: "bg-violet-50 text-violet-700 ring-violet-200", interview: "bg-blue-50 text-blue-700 ring-blue-200", offer: "bg-emerald-50 text-emerald-700 ring-emerald-200", closed: "bg-slate-100 text-slate-700 ring-slate-200" };
