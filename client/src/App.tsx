...
import { RequestSharePreview } from "./pages/GrowthPreviews";
import AdminActivity from "./pages/AdminActivity";
import Settings from "./pages/Settings";
import MyRequests from "./pages/MyRequests";
import MyCompanyInbox from "./pages/MyCompanyInbox";
import AdminFlowHealth from "./pages/AdminFlowHealth";
function Router(){return <Switch><Route path="/" component={Home}/><Route path="/start" component={Onboarding}/><Route path="/request" component={ReferralRequest}/><Route path="/requests" component={MyRequests}/><Route path="/inbox" component={MyCompanyInbox}/><Route path="/referrer" component={Referrer}/><Route path="/premium" component={Premium}/><Route path="/settings" component={Settings}/><Route path="/wall" component={OpportunityWall}/><Route path="/post-opportunity" component={PostOpportunity}/><Route path="/admin/activity" component={AdminActivity}/><Route path="/admin/flow-health" component={AdminFlowHealth}/><Route path="/request-share-preview" component={RequestSharePreview}/><Route component={NotFound}/></Switch>}
