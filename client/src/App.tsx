...
export default function App(){return <ErrorBoundary><ThemeProvider defaultTheme="light"><TooltipProvider><Toaster/><Router/><TokenTopUp/></TooltipProvider></ThemeProvider></ErrorBoundary>}
