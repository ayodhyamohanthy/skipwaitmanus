...
function Router(){return <Switch><Route path="/" component={Home}/><Route path="/start" component={Onboarding}/><Route path="/request" component={ReferralRequest}/><Route path="/referrer" component={Referrer}/><Route path="/premium" component={Premium}/><Route path="/settings" component={Settings}/><Route path="/wall" component={OpportunityWall}/><Route path="/post-opportunity" component={PostOpportunity}/><Route path="/admin/activity" component={AdminActivity}/><Route path="/request-share-preview" component={RequestSharePreview}/><Route component={NotFound}/></Switch>}
