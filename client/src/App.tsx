...
import { OpportunityPostPreview, OpportunityWallPreview, RequestSharePreview } from "./pages/GrowthPreviews";
function Router(){return <Switch><Route path="/" component={Home}/><Route path="/start" component={Onboarding}/><Route path="/request" component={ReferralRequest}/><Route path="/referrer" component={Referrer}/><Route path="/premium" component={Premium}/><Route path="/wall" component={OpportunityWallPreview}/><Route path="/post-opportunity" component={OpportunityPostPreview}/><Route path="/request-share-preview" component={RequestSharePreview}/><Route component={NotFound}/></Switch>}
