...
function PwaSessionContinuity(){const {isLoaded,isSignedIn}=useClerkAuth();useEffect(()=>{if(isLoaded&&isSignedIn)markSecureSessionVerified()},[isLoaded,isSignedIn]);return null}
