...
| Referrer | Use a real controlled company inbox to test OTP, personal-domain rejection, candidate packet, claim, approve/decline, conversation, and progress update. | OTP goes only to entered work email; unrelated employer cannot access any packet. |
